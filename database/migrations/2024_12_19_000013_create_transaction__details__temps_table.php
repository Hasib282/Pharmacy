...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_second')->create('transaction__details__temps', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mysql_second')->dropIfExists('transaction__details__temps');
    }
};
