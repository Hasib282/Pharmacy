    ...
    <div class="modal-subject">
        ...
        <form id="EditForm" method="post">
            ...
            <div class="form-input-group">
                ...
                <input type="text" name="category" class="form-input" id="updateCategory" data-url="{{ Request::segment(1) }}/setup/category/get" autocomplete="off">
            ...
            <div class="form-input-group">
                ...
                <input type="text" name="manufacturer" class="form-input" id="updateManufacturer" data-url="{{ Request::segment(1) }}/setup/manufacturer/get" autocomplete="off">
            ...
            <div class="form-input-group">
                ...
                <input type="text" name="form" class="form-input" id="updateForm" data-url="{{ Request::segment(1) }}/setup/form/get" autocomplete="off">
                <div id='update-form'>
                    <ul>
            ...
            <div class="form-input-group">
                ...
                <input type="text" name="unit" class="form-input" id="updateUnit" data-url="{{ Request::segment(1) }}/setup/unit/get" autocomplete="off">
                <div id='update-unit'>
                    <ul>
