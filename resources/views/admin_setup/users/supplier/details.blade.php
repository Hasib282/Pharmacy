<ul>
    ...
    <div class="general">
        <div class="details-head">
            <div class="image-round">
                <img src="http://localhost:8001/storage/profiles/{{ $supplier->image !== null ? $supplier->image : ($supplier->gender == 'female' ? 'female.png' : 'male.png') }}" alt="" height="100px" width="100px">
            </div> 
            <div class="highlight">
        ...
        <div class="details-table" style="">
            ...
            <div class="rows each-row"> 
                ...
                <div class="c-4">{{$supplier->nid}}</div>
            </div>
        </div>
    </div>
    ...
    <div class="contact">
        <div class="details-table" style="">
            <div class="rows each-row"> 
                <div class="c-3 bold">Email</div>
                <div class="c-9">{{$supplier->user_email}}</div>
            </div>
            <div class="rows each-row"> 
                <div class="c-3 bold">Contact No</div>
                <div class="c-9">{{$supplier->user_phone}}</div>
            </div>
        </div>
    </div>
    ...
    <div class="address">
        <div class="details-table" style="">
            <div class="rows each-row"> 
                ...
                <div class="c-9">{{$supplier->address}}</div>
            </div>
            <div class="rows each-row"> 
