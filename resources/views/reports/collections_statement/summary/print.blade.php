                        ...
                        <table class="show-table" style="margin:20px 0;">
                            ...
                            <tbody>
                                @foreach($datas as $key => $item)
                                    ...
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>{{ $item['tran_groupe_id'] != $lastGroupeId ? $item['groupe']['tran_groupe_name'] : '' }}</td>
                                        <td>{{ $item['head']['tran_head_name'] }}</td>
                                        <td style="text-align: right">{{ number_format($item['total_receive']) }}</td>
                                        <td style="text-align: right">{{ number_format($item['total_payment']) }}</td>
                                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">{{ number_format($totalReceive) }}</td>
                                    <td style="text-align: right;">{{ number_format($totalPayment) }}</td>
                                </tr>     
                            </tbody>
                        </table>
                    </td>
