   ...
   <div class="container-fluid">
            ...
            <div class="page-title-box">
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     <h4>
                        <a href="{{ route('show.employeeAttendence') }}" class="btn btn-primary float-sm-right m-2"><i
                              class="fas fa-list float-sm-center"></i> Employee Attendance List</a>
                     </h4>
                  </ol>
               </div>
            </div>
      ...
      <div class="row">
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <form action="{{ route('insert.employeeAttendence') }}" method="post" id="myForm">
                     @csrf
                     <div class="form-group col-md-4">
                        <label for="date" class="control-label">Attendance Date</label>
                        <input type="date" name="date" id="date"
                           class="checkdate form-control form-control-sm singledatepicker" placeholder="Attendance Date"
                           autocomplete="off">
                     </div>
                           ...
                           <tr id="div {{$employee->id}}" class="text-center">
                              ...
                              <td colspan="3">
                                 <div class="switch-toggle switch-3 switch-candy">
                                    ...
                                    <input class="leave" id="leave{{$key}}" name="attend_status{{$key}}" value="Leave"
                                       type="radio">
