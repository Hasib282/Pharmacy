            ...
            <div class="rows">
                ...
                <div class="c-6">
                    <div class="form-input-group">
                        <label for="update_level_of_education">Level of Education <span class="required" title="Required">*</span></label>
                ...
                <div class="c-6">
                    <div class="form-input-group">
                        <label for="update_degree_title">Degree Title <span class="required" title="Required">*</span></label>
                ...
                <div class="c-6">
                    <div class="form-input-group">
                        <label for="update_institution_name">Institution Name <span class="required" title="Required">*</span></label>
                ...
                <div class="c-6 hidden" id="update_scale-group">
                    <div class="form-input-group">
                        <label for="update_scale">Scale <span class="required" title="Required">*</span></label>
                ...
                <div class="c-6 hidden" id="update_cgpa-group">
                    <div class="form-input-group">
                        <label for="update_cgpa">CGPA <span class="required" title="Required">*</span></label>
                ...
                <div class="c-6 hidden" id="update_marks-group">
                        <div class="form-input-group">
                            <label for="update_marks">Marks <span class="required" title="Required">*</span></label>
                ...
                <div class="c-6">
                    <div class="form-input-group">
                        <label for="update_passing_year">Passing Year <span class="required" title="Required">*</span></label>
