    ...
    <div class="modal-subject" style="width: 40%;">
        ...
        <form id="EditForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-input-group">
                ...
                <input type="text" name="specialization" class="form-input" id="updateSpecialization" autocomplete="off"><hr>
                <div id='update-specialization'></div>
            ...
            <div class="form-input-group">
                ...
                <input type="text" name="marketing_head" class="form-input" id="updateMarketing_Head" autocomplete="off"><hr>
                <div id='update-marketing_head'></div>
