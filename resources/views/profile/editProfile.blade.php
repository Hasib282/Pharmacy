<div id="editInventoryPurchase" class="modal-container">
    <div class="modal-subject">
        ...
        <form id="EditInventoryPurchaseForm" method="post" enctype="multipart/form-data">
            ...
            <div class="rows">
                <div class="c-6">
                    ...
                    <div id="updategroupein" style="display: none">
                        ...
                        <input type="checkbox" id="groupe[]" name="groupe" class="updategroupe-checkbox"
                    ...
                    <div class="center">
                        <button type="submit" id="UpdateInventoryPurchaseDetails" class="btn-blue">Add</button>
                    </div>
                </div>
            ...
            {{--  end of row --}}
            <div class="center">
                <button id="UpdateInventoryPurchaseMain" class="btn-blue" style="margin-top: 10px;">Update</button>
            </div>
        </form>
    </div>
</div>