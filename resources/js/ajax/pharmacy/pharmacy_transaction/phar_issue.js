$(document).ready(function () {
    ...
    /////////////// ------------------ Add Pharmacy Issue Ajax Part Start ---------------- /////////////////////////////
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == "success") {
                    ...
                    $('#product').focus();
                    localStorage.removeItem('addData');
                    toastr.success('Pharmacy Issue Added Successfully', 'Added!');
                }
            },
            error: function (err) {
    ...
    ///////////// ------------------ Edit Pharmacy Issue Main ajax part start ---------------- /////////////////////////////
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == "success") {
                    ...
                    $('#editModal').hide();
                    localStorage.removeItem('editData');
                    toastr.success('Pharmacy Issue Updated Successfully', 'Updated!');
                }
            },
            error: function (err) {
                let error = err.responseJSON;
    ...
    DeleteAjax('Pharmacy Issue Details Deleted', 'Deleted!');

    PaginationAjax({ type: 6, method: 'Issue' });

    SearchAjax({ type: 6, method: 'Issue' });
    
    SearchByDateAjax({ type: 6, method: 'Issue' });

    SearchPaginationAjax({ type: 6, method: 'Issue' });
