$(document).ready(function () {
    ...
    $(document).on('click', '#edit', function (e) {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                console.log(res.adjust.quantity)
    ...
    PaginationAjax({ type: 6, method: 'Positive' });

    SearchAjax({ type: 6, method: 'Positive' });
    
    SearchByDateAjax({ type: 6, method: 'Positive' });

    SearchPaginationAjax({ type: 6, method: 'Positive' });
});