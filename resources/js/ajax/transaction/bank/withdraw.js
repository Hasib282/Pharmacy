$(document).ready(function () {
    ...
    /////////////// ------------------ Add Bank Withdraw Ajax Part Start ---------------- /////////////////////////////
    ...
    PaginationAjax({ type: 4, method: 'Withdraw' });

    SearchAjax({ type: 4, method: 'Withdraw' });
    
    SearchByDateAjax({ type: 4, method: 'Withdraw' });

    SearchPaginationAjax({ type: 4, method: 'Withdraw' });
});