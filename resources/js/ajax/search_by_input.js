$(document).ready(function () {
    ...
    function getDesignationByNameAndDepartment(designation, targetElement1, department = "") {
        $.ajax({
            url: "/hr/designation/get/department",
            method: 'GET',
    ...
    function getLocationByDivision(location, division, targetElement1) {
        $.ajax({
            url: "/admin/location/get/division",
            method: 'GET',
    ...
    // Bank Keyup Event
    $(document).on('keyup', '#bank', function (e) {
        let bank = $(this).val();
        let id = $(this).attr('data-id');
    ...
    // Bank Keydown Event
    $(document).on('keydown', '#bank', function (e) {
    ...
    $(document).on('keydown', '#bank-list ul li', function (e) {
        let list = $('#bank-list ul li');
    ...
    $(document).on('click', '#bank-list li', function () {
        let value = $(this).text();
        let id = $(this).data('id');
        $('#bank').val(value);
    ...
    // Bank Focus Event
    $(document).on('focus', '#bank', function (e) {
        let bank = $(this).val();
        let id = $(this).attr('data-id');
        if(id == undefined){
    ...
    // Locaation Focousout event
    $(document).on('focusout', '#bank', function (e) {
        let id = $(this).attr('data-id');
        if(id == undefined){
            $(document).on('click', function (e){
                if($(e.target).attr('tabindex') == undefined){
    ...
    $(document).on('keyup', '#updateBank', function (e) {
        let bank = $(this).val();
        let id = $(this).attr('data-id');
    ...
    $(document).on('keydown', '#updateBank', function (e) {
    ...
    $(document).on('click', '#update-bank li', function () {
        let value = $(this).text();
        let id = $(this).data('id');
    ...
    $(document).on('focus', '#updateBank', function (e) {
        let bank = $(this).val();
        let id = $(this).attr('data-id');
        if(id == undefined){
    ...
    // Update Locaation Focousout Event
    $(document).on('focusout', '#updateBank', function (e) {
        let id = $(this).attr('data-id');
        if(id == undefined){
            $(document).on('click', function (e){
                if($(e.target).attr('tabindex') == undefined){
    ...
    function getTransactionUser(tranUserType, within, tranUser, targetElement1) {
        $.ajax({
            ...
            method: 'GET',
            data: { tranUserType, within:within, tranUser: tranUser },
            success: function (res) {
                $(targetElement1).html(res);
            }
        });
    ...
    function getHeadByGroupe(groupe, groupein, head, targetElement1) {
        $.ajax({
            url: "/admin/tranheads/get/groupe",
            method: 'GET',
    ...
    function getProductByGroupe(groupe, groupein, product, targetElement1) {
        $.ajax({
            url: "/inventory/setup/product/get",
            method: 'GET',
    ...
    $(document).on('keydown', '#batch-list ul li', function (e) {
        let list = $('#batch-list ul li');
    ...
    $(document).on('click', '#batch-list li', function () {
        let value = $(this).text();
        let id = $(this).data('id');
        $('#batch').val(value);
    ...
    $(document).on('keyup', '#updateBatch', function (e) {
        let batch = $(this).val();
        let id = $(this).attr('data-id');
    ...
    $(document).on('keydown', '#updateBatch', function (e) {
    ...
    $(document).on('keydown', '#update-batch ul li', function (e) {
        let list = $('#update-batch ul li');
    ...
    $(document).on('focus', '#updateBatch', function (e) {
        let batch = $(this).val();
        let id = $(this).attr('data-id');
        if(id == undefined){
    ...
    $(document).on('focusout', '#updateBatch', function (e) {
        let id = $(this).attr('data-id');
        if(id == undefined){
            $(document).on('click', function (e){
                if($(e.target).attr('tabindex') == undefined){
    ...
    $(document).on('click', '#update-batch li', function () {
        let value = $(this).text();
        let id = $(this).data('id');
    ...
    function getBatch(batch, targetElement1) {
        ...
        $.ajax({
            url: "/inventory/transaction/get/batch/id",
            method: 'GET',
