$(document).ready(function () {
    ...
    PaginationAjax({ type: 5, method: 'Negative' });

    SearchAjax({ type: 5, method: 'Negative' });
    
    SearchByDateAjax({ type: 5, method: 'Negative' });

    SearchPaginationAjax({ type: 5, method: 'Negative' });
});