$(document).ready(function () {
    ...
    $(document).on('change', '#startDate, #endDate', function(e){
        ...
        LoadData(`/inventory/report/search/item/flow`, {search, startDate, endDate})
    });
    ...
    $(document).on('click', '.search-paginate a', function (e) {
        ...
        LoadData(`/inventory/report/search/item/flow?page=${page}`, {search, startDate, endDate})
    });
    ...
    function getProductByGroupe(groupe, groupein, product, targetElement1) {
        $.ajax({
            url: "/inventory/report/get/product/list",
            method: 'GET',
