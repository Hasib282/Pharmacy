$(document).ready(function () {
    ...
    // Individual checkboxes click handler
    $(document).on('click', '[class^=permission-]', function() {
        // console.log($('[id^=select-all-]').length);
        let mainhead = this.id.split('-').pop();
    ...
    ///////////// ------------------ Edit Role Permission ajax part start ---------------- /////////////////////////////
    ...
    /////////////// ------------------ Assign Role Permission ajax part start ---------------- /////////////////////////////
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == "success") {
                    ...
                    toastr.success('Role Permission Updated Successfully', 'Updated!');
                }
            },
            error: function (err) {
