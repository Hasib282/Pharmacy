$(document).ready(function () {
    ...
    ///////////// ------------------ Edit User Permission ajax part start ---------------- /////////////////////////////
    ...
    /////////////// ------------------ Update User Permission ajax part start ---------------- /////////////////////////////
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == "success") {
                    ...
                    toastr.success('User Permission Updated Successfully', 'Updated!');
                }
            },
            error: function (err) {
    ...
    SearchAjax({ method: $('#role').val() });

    SearchPaginationAjax({ method: $('#role').val() });
    ...
    $(document).on('change', '#role', function (e){
        ...
        let role = $(this).val();
        LoadData(urls.search, { search, role })
    });
});