...
$(document).ready(function () {
    ...
    // Insert Ajax
    InsertAjax('inventory/users/clients', ShowClients, {location: { selector: '#location', attribute: 'data-id' }, company: { selector: '#company', attribute: 'data-id' }}, function() {
        $('#type').focus();
    ...
    // Edit Ajax
    EditAjax('inventory/users/clients', EditFormInputValue);


    // Update Ajax
    UpdateAjax('inventory/users/clients', ShowClients, {location: { selector: '#updateLocation', attribute: 'data-id' }});
    

    // Delete Ajax
    DeleteAjax('inventory/users/clients', ShowClients);
    ...
    // Search Ajax
    // SearchAjax('inventory/users/clients', ShowClients);
    ...
    // Show Detals Ajax
    DetailsAjax('inventory/users/clients');


    // Creating Select Options Dynamically
    GetTransactionWith(5, null, null, 4, 'Ok');
});