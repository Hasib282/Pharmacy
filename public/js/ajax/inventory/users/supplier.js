...
$(document).ready(function () {
    ...
    // Insert Ajax
    InsertAjax('inventory/users/suppliers', ShowSuppliers, {location: { selector: '#location', attribute: 'data-id' }, company: { selector: '#company', attribute: 'data-id' }}, function() {
        $('#type').focus();
    ...
    // Edit Ajax
    EditAjax('inventory/users/suppliers', EditFormInputValue);


    // Update Ajax
    UpdateAjax('inventory/users/suppliers', ShowSuppliers, {location: { selector: '#updateLocation', attribute: 'data-id' }});
    

    // Delete Ajax
    DeleteAjax('inventory/users/suppliers', ShowSuppliers);
    ...
    function EditFormInputValue(res){
        ...
        $('#updatePreviewImage').attr('src',`${apiUrl.replace('/api', '')}/storage/${res.supplier.image ? res.supplier.image : (res.supplier.gender == 'female' ? 'female.png' : 'male.png')}?${new Date().getTime()} `).show();
        $('#updateType').focus();
    }; // End Method
