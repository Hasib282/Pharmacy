// function ShowInventoryClientReturnDetails(data, startIndex) {
//     let tableRows = '';
//     let totalQuantity = 0;
//     let totalMrp = 0;
...
function ShowInventoryClientReturnDetails(res) {
    tableInstance = new GenerateTable({
        tableId: '#data-table',
        data: res.data,
        tbody: ['tran_id','user.user_name','head.tran_head_name','quantity_actual',{key:'cp', type: 'number'},{key:'totCP', type: 'number'},{key:'discount', type: 'number'},{key:'tot_amount', type: 'number'},{key:'receive', type: 'number'},{key:'due', type: 'number'},{key:'tran_date', type: 'date'}],
    });
}
...
$(document).ready(function () {
    ...
    // Pagination Ajax
    // PaginationAjax(ShowInventoryClientReturnDetails);


    // Search Ajax
    // SearchAjax('inventory/report/return/client/details', ShowInventoryClientReturnDetails, { type:'5', method:'Client Return' });


    // Search By Month or Year
    // SearchByDateAjax('inventory/report/return/client/details', ShowInventoryClientReturnDetails, { type:'5', method:'Client Return' })
});