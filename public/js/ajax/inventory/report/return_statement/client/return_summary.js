function ShowInventoryClientReturnSummarys(res) {
...
$(document).ready(function () {
    ...
    SearchByDateAjax('inventory/report/return/client/summary/search', ShowInventoryClientReturnSummarys, { method:'Client Return' })
});