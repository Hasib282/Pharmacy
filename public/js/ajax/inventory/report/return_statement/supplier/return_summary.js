// function ShowInventorySupplierReturnSummarys(data, startIndex) {
//     let tableRows = '';
...
$(document).ready(function () {
    ...
    // Pagination Ajax
    // PaginationAjax(ShowInventorySupplierReturnSummarys);


    // Search Ajax
    // SearchAjax('inventory/report/return/supplier/summary', ShowInventorySupplierReturnSummarys, { type:'5', method:'Supplier Return' });


    // Search By Month or Year
    // SearchByDateAjax('inventory/report/return/supplier/summary', ShowInventorySupplierReturnSummarys, { type:'5', method:'Supplier Return' })
});