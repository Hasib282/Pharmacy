...
$(document).ready(function () {
    ...
    $.ajax({
        url: `${apiUrl}/inventory/report/item/flow`,
        method: "GET",
    ...
    SearchByDateAjax('inventory/report/item/flow', ShowInventoryItemflowStatements, {search_id: { selector: '#search', attribute: 'data-id' }})
