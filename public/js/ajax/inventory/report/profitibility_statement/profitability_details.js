function ShowInventoryProfitabilityDetails(res) {
...
$(document).ready(function () {
    ...
    SearchByDateAjax('inventory/report/profitability/statement/search', ShowInventoryProfitabilityDetails, { method:'Issue' })
});