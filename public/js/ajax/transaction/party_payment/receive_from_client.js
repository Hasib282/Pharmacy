...
$(document).ready(function () {
    ...
    // Search Ajax
    SearchAjax('transaction/party/receive', ShowReceiveFromClients, { type: 2, method: 'Receive' });


    // Search By Date
    SearchByDateAjax('transaction/party/receive', ShowReceiveFromClients, {type: 2, method: 'Receive'});
