...
$(document).ready(function () {
    ...
    // Insert Ajax
    InsertAjax('pharmacy/users/clients', ShowClients, {location: { selector: '#location', attribute: 'data-id' }, company: { selector: '#company', attribute: 'data-id' }}, function() {
        $('#type').focus();
    ...
    // Edit Ajax
    EditAjax('pharmacy/users/clients', EditFormInputValue);


    // Update Ajax
    UpdateAjax('pharmacy/users/clients', ShowClients, {location: { selector: '#updateLocation', attribute: 'data-id' }});
    

    // Delete Ajax
    DeleteAjax('pharmacy/users/clients', ShowClients);
    ...
    // Search Ajax
    // SearchAjax('pharmacy/users/clients', ShowClients);
