// function ShowPharmacySupplierReturns(data, startIndex) {
//     let tableRows = '';
...
function ShowPharmacySupplierReturns(res) {
    tableInstance = new GenerateTable({
        ...
        tbody: ['tran_id','user.user_name',{key:'bill_amount', type: 'number',footerType:'sum'},{key:'discount', type: 'number',footerType:'sum'},{key:'net_amount', type: 'number',footerType:'sum'},{key:'payment', type: 'number',footerType:'sum'},{key:'due_col', type: 'number',footerType:'sum'},{key:'due_disc', type: 'number',footerType:'sum'},{key:'due', type: 'number',footerType:'sum'}],
         ...
         actions: (row) => {
            ...
            if (userPermissions.includes(163) || role == 1) {
                buttons += `
            ...
            if (userPermissions.includes(164) || role == 1) {
                buttons += `
...
$(document).ready(function () {
    ...
    InsertTransaction('pharmacy/transaction/return/supplier', 'Supplier Return', '6', function() {
        $('#batch').removeAttr('data-id');
        $('#user').removeAttr('data-id');
        $('#user').removeAttr('data-with');
    ...
    // Update Ajax
    // UpdateAjax('pharmacy/transaction/return/supplier', ShowPharmacySupplierReturns);
    ...
    // Search By Date Ajax
    SearchByDateAjax('pharmacy/transaction/return/supplier/search', ShowPharmacySupplierReturns, { type: 6, method: 'Supplier Return' });
    ...
    // /////////////// ------------------ Add Pharmacy Supplier Return Ajax Part Start ---------------- /////////////////////////////
