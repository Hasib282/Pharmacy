...
function ShowPharmacyClientReturns(res) {
    tableInstance = new GenerateTable({
        ...
        actions: (row) => {
            ...
            if (userPermissions.includes(159) || role == 1) {
                buttons += `
...
$(document).ready(function () {
    ...
    InsertTransaction('pharmacy/transaction/return/client', 'Client Return', '6', function() {
        $('#batch').removeAttr('data-id');
        $('#user').removeAttr('data-id');
        $('#user').removeAttr('data-with');
    ...
    // Delete Ajax
    DeleteAjax('pharmacy/transaction/return/client');
    

    // Delete status  Ajax
    DeleteStatusAjax('pharmacy/transaction/return/client');
    
    
    // Search By Date Ajax
    SearchByDateAjax('pharmacy/transaction/return/client/search', ShowPharmacyClientReturns, { type: 6, method: 'Client Return' });
