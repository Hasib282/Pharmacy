// function ShowPharmacyClientReturns(data, startIndex) {
//     let tableRows = '';
...
function ShowPharmacyClientReturns(res) {
    new GenerateTable({
        tableId: '#data-table',
        data: res.data,
...
$(document).ready(function () {
    ...
    ReloadData('pharmacy/transaction/return/client', ShowPharmacyClientReturns);
    ...
    // Insert Ajax
    // InsertAjax('pharmacy/transaction/return/client', ShowPharmacyClientReturns, {}, function() {
    //     $('#division').focus();
    // });


    //Edit Ajax
    // EditAjax('pharmacy/transaction/return/client', EditFormInputValue);


    // Update Ajax
    // UpdateAjax('pharmacy/transaction/return/client', ShowPharmacyClientReturns);
    

    // Delete Ajax
    DeleteAjax('pharmacy/transaction/return/client', ShowPharmacyClientReturns);


    // Pagination Ajax
    // PaginationAjax(ShowPharmacyClientReturns);


    // Search Ajax
    // SearchAjax('pharmacy/transaction/return/client', ShowPharmacyClientReturns, { type: 6, method: 'Client Return' });
    
    
    // Search By Date Ajax
    // SearchByDateAjax('pharmacy/transaction/return/client', ShowPharmacyClientReturns, { type: 6, method: 'Client Return' });
    ...
    /////////////// ------------------ Add Pharmacy Client Return Ajax Part Start ---------------- /////////////////////////////
    $(document).off('click', '#Insert').on('click', '#Insert', function (e) {
        ...
        $.ajax({
            url: `${apiUrl}/pharmacy/transaction/return/client`,
            method: 'POST',
