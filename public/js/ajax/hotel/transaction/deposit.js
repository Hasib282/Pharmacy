function ShowDeposits(res) {
    tableInstance = new GenerateTable({
        ...
        actions: (row) => {
            ...
            if (userPermissions.includes(337) || role == 1) {
                buttons += `
            ...
            if (userPermissions.includes(338) || role == 1) {
                buttons += `
...
$(document).ready(function () {
    ...
    ReloadData('hotel/transaction/deposits', ShowDeposits);
    ...
    // Delete  status Ajax
    DeleteStatusAjax('hotel/transaction/deposits');


    // Search By Date
    SearchByDateAjax('hotel/transaction/deposits/search', ShowDeposits, {type: 8, method: 'Deposit'});
