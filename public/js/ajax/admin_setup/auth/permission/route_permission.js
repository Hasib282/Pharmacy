...
$(document).ready(function () {
    ...
    ReloadData('admin/auth/permission/routepermissions', ShowPermissionMainheads);


    //Edit Ajax
    EditAjax('admin/auth/permission/routepermissions', EditFormInputValue);


    // Update Ajax
    UpdateAjax('admin/auth/permission/routepermissions', ShowPermissionMainheads, {}, function() {
    ...
    // Search Ajax
    SearchAjax('admin/auth/permission/routepermissions', ShowPermissionMainheads, {  });
