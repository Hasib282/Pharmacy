...
$(document).ready(function () {
    ...
    $.ajax({
        url: `${apiUrl}/admin/auth/permission/userpermissions`,
        method: "GET",
    ...
    //Edit Ajax
    EditAjax('admin/auth/permission/userpermissions', EditFormInputValue);


    // Update Ajax
    UpdateAjax('admin/auth/permission/userpermissions', ShowUserPermissions, {}, function() {
    ...
    // Search Ajax
    SearchAjax('admin/auth/permission/userpermissions', ShowUserPermissions, {role: { selector: "#role"}});


    // Search By Methods, Roles, Types
    SearchBySelect('admin/auth/permission/userpermissions', ShowUserPermissions, '#role', {role: { selector: "#role"}});
