...
$(document).ready(function () {
    ...
    ReloadData('admin/permission/rolepermissions', ShowRolePermissions);


    //Edit Ajax
    EditAjax('admin/permission/rolepermissions', EditFormInputValue);


    // Update Ajax
    UpdateAjax('admin/permission/rolepermissions', ShowRolePermissions, {}, function() {
        $('#select-all').prop('checked', false);
    });


    // Search Ajax
    SearchAjax('admin/permission/rolepermissions', ShowRolePermissions, {  });
