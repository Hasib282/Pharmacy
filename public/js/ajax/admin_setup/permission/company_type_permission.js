                ...
                groupedPermissions[groupKey] += `
                        <div class="c-3">
                            <label for="permissions-${item.id}" style="font-weight: normal;">
                                <input type="checkbox" id="permissions-${item.id}" class="permission permission-${item.permission_mainhead}" name="permissions[]" value="${item.id}" ${res.companytypepermission.includes(item.id) ? 'checked' : ''} />
                                ${item.name}
                            </label>
                        </div>
                    `;
