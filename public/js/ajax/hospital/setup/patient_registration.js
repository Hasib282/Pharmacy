...
$(document).ready(function () {
    ...
    // Insert Ajax
    InsertAjax('hospital/ptnregistration', ShowPatientRegistration, {bed_category: { selector: '#bed_category', attribute: 'data-id' }, bed_list: { selector: '#bed_list', attribute: 'data-id' }, doctor: { selector: '#doctor', attribute: 'data-id' }, sr: { selector: '#sr', attribute: 'data-id' }}, function() {
        $('#title').focus();
        $('#bed_category').removeAttr('data-id');
        $('#bed_list').removeAttr('data-id');
        $('#doctor').removeAttr('data-id');
    ...
    //Edit Ajax
    EditAjax('hospital/ptnregistration', EditFormInputValue);


    // Update Ajax
    UpdateAjax('hospital/ptnregistration', ShowPatientRegistration);
    

    // Delete Ajax
    DeleteAjax('hospital/ptnregistration', ShowPatientRegistration);
