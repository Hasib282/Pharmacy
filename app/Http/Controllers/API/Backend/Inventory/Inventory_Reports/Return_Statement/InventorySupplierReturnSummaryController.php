...
class InventorySupplierReturnSummaryController extends Controller
{
    // Show All Inventory Supplier Return Summary Statement
    ...
    // Print Inventory Supplier Return Summary Report
    public function Print(Request $req){
        ...
        $report_name = 'Inventory Supplier Return Summary Report';
