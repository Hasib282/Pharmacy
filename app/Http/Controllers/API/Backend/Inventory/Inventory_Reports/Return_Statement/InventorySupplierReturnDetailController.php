...
class InventorySupplierReturnDetailController extends Controller
{
    // Show All Inventory Supplier Return Details Statement
    ...
    // Print Inventory Supplier Return Details Report
    public function Print(Request $req){
        ...
        $report_name = 'Inventory Supplier Return Details Report';
