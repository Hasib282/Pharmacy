...
class InventoryClientReturnSummaryController extends Controller
{
    // Show All Inventory Client Return Summary Statement
    ...
    // Print Inventory Client Return Summary Report
    public function Print(Request $req){
        ...
        $report_name = 'Inventory Client Return Summary Report';
