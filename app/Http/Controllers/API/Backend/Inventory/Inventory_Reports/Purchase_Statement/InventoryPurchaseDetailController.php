...
{
    // Show All Inventory Purchase Details Statement
    ...
    // Print Inventory Purchase Details Report
    public function Print(Request $req){
        ...
        $report_name = 'Inventory Purchase Details Report';
        $start_date = $req->startDate ? $req->startDate : date('d/m/Y');
        $end_date = $req->endDate ? $req->endDate : date('d/m/Y');
        $pdf = Pdf::loadView('reports.product_reports.purchase_statement.details.print', compact('report_name', 'start_date', 'end_date', 'data'))->setPaper('a4', 'portrait');
        return $pdf->stream();
    } // End Method
}
