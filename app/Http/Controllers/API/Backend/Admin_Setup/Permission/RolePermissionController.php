...
class RolePermissionController extends Controller
{
    ...
    public function ShowAll(Request $req){
        $rolepermission = Role::on('mysql')->whereNotIn('id', ['1'])->with('permissions')->orderBy('id')->get();
    ...
    public function Edit(Request $req){
        $role = Role::on('mysql')->whereNotIn('id', ['1'])->where('id',$req->id)->first();
        $rolepermission = Permission_Role::on('mysql')->where('role_id', $req->id)->pluck('permission_id')->toArray();
    ...
    public function Update(Request $req){
        $role = Role::on('mysql')->whereNotIn('id', ['1'])->findOrFail($req->role);
    ...
    public function Search(Request $req){
        $rolepermission = Role::on('mysql')->whereNotIn('id', ['1'])
