...
class PharmacyCategoryController extends Controller
{
    ...
    public function ShowAll(Request $req){
        $category = Item_Category::on('mysql')->where('type_id', '6')->orderBy('added_at','asc')->paginate(15);
    ...
    public function Search(Request $req){
        $category = Item_Category::on('mysql')->where('type_id', '6')
    ...
    public function Get(Request $req){
        $categories = Item_Category::on('mysql')->where('type_id', '6')
