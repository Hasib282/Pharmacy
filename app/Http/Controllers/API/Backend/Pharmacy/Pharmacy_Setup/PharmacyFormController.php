...
class PharmacyFormController extends Controller
{
    ...
    public function ShowAll(Request $req){
        $form = Item_Form::on('mysql')->where('type_id', '6')->orderBy('added_at','asc')->paginate(15);
    ...
    public function Search(Request $req){
        $form = Item_Form::on('mysql')->where('type_id', '6')
    ...
    public function Get(Request $req){
        $forms = Item_Form::on('mysql')->where('type_id', '6')
