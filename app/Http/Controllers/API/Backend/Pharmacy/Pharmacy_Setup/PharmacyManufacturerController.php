...
class PharmacyManufacturerController extends Controller
{
    ...
    public function ShowAll(Request $req){
        $manufacturer = Item_Manufacturer::where('type_id', '6')->orderBy('added_at','asc')->paginate(15);
    ...
    public function Search(Request $req){
        $manufacturer = Item_Manufacturer::where('type_id', '6')
    ...
    public function Get(Request $req){
        $manufacturers = Item_Manufacturer::where('type_id', '6')
