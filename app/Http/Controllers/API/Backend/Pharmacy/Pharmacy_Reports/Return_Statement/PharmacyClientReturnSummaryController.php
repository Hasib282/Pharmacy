...
class PharmacyClientReturnSummaryController extends Controller
{
    // Show All Pharmacy Client Return Summary Statement
    ...
    // Print Pharmacy Client Return Summary Report
    public function Print(Request $req){
        ...
        $report_name = 'Pharmacy Client Return Summary Report';
