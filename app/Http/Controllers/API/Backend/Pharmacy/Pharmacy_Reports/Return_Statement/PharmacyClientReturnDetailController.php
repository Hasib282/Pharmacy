...
class PharmacyClientReturnDetailController extends Controller
{
    // Show All Pharmacy Client Return Details Statement
    ...
    // Print Pharmacy Client Return Details Report
    public function Print(Request $req){
        ...
        $report_name = 'Pharmacy Client Return Details Report';
