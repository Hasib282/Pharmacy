...
class SupplierReturnDetailController extends Controller
{
    // Show All Supplier Return Details Statement
    ...
    // Search Supplier Return Details Statement
    ...
    // Print Supplier Return Details Report
    public function Print(Request $req){
        ...
        $report_name = 'Supplier Return Details Report';
